...
<body>
	...
	<marquee><h1>faculty of Chemical & Natural Resources Engineering</h1></marquee>
...
<p align="center">&nbsp;
       ...
       <p>&nbsp;       </p>
	   <h3>Faculty of Chemical & Natural Resources Engineering</h3>
	   ...
	   <table width="60%" border="0" align="center">
		...
		$query = "SELECT * FROM idea WHERE faculty='fkksa'";
		$result = mysql_query($query, $conn);
            ...
            <td class="style3"><br><strong><?php echo $title ?></strong>
			<br>
	...
	<img src="pic/liker.gif" width="100px" height="50px" align="left" onClick="onClick()"></div></td>
