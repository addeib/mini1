...
<body>
	...
	<marquee><h1>Faculty of Civil Engineering & Earth Resources</h1></marquee>
...
<p align="center">&nbsp;
       ...
       <p>&nbsp;       </p>
	   <h3>Faculty of Civil Engineering & Earth Resources</h3>
	   ...
	   <table width="60%" border="0" align="center">
		...
		$query = "SELECT * FROM idea WHERE faculty='fkasa'";
		$result = mysql_query($query, $conn);
            ...
            <td class="style3"><strong><br><?php echo $title ?></strong>
			<br>
