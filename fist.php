...
<body>
	...
	<marquee><h1>Faculty of Industrial Sciences & Technology</h1></marquee>
...
<p align="center">&nbsp;
       ...
       <p>&nbsp;       </p>
	   <h3>Faculty of Industrial Sciences & Technology</h3>
	   ...
	   <table width="60%" border="0" align="center">
		...
		$query = "SELECT * FROM idea WHERE faculty='fist'";
