...
.style3 {font-size: 10px ;font-family:verdana, helvetica, sans-serif}
.style5 {
	color: #000000;
	font-weight: bold;
}
...
<body>
	...
	<p><a href="insert_idea.php">Submit Your Idea</a>
	
	<form method="post" action="search.php?go" id="searchform">

	<strong>Search Keywords :</strong>
	<th><input type="text" name="name"></th>
	<th><input type="submit" name="submit" value="Search"></th></p>
	...
	<p align="center">&nbsp;
       ...
       <tr>
		 ...
		 <?php
			...
			$name=$_POST['name'];
			$sql="SELECT  * FROM idea WHERE faculty LIKE '%" . $name .  "%' OR title LIKE '%" .  $name . "%' OR description LIKE '%" . $name ."%' OR project LIKE '%" . $name ."%' OR tags LIKE '%" . $name ."%' OR uploader LIKE '%" . $name ."%'";
		...
		?>
			...
			<tr  onMouseOut="this.style.backgroundColor='#F0F0F0'" bgcolor="#F0F0F0" class="style3">
				<td class="style3"><strong><?php echo $title ?></strong>
				<br>
				...
				<img src="pic/liker.gif" width="100px" height="50px" align="left" onClick="onClick()"></form></div>
				</td>
