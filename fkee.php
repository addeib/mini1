...
<body>
	...
	<marquee><h1>Faculty of Electrical & Electronics Engineering</h1></marquee>
...
<p align="center">&nbsp;
       ...
       <p>&nbsp;       </p>
	   <h3>Faculty of Electrical & Electronics Engineering</h3>
	   ...
	   <table width="60%" border="0" align="center">
		...
		$query = "SELECT * FROM idea WHERE faculty='fkee'";
