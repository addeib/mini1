...
<form method ="post" action="sessionHandler.php">
	...
	<input type="text" placeholder="Please Enter Username..." name="username" required><br><br>
	<input type="password" placeholder="Please Enter Password..."name="password" required><br><br>
